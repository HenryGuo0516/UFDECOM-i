	SUBROUTINE  GETEL11_FLUX(KY,KKM,KDAY,TIMES,ADEPTH,HA,GA,EL)
	PARAMETER(PI=3.1415926)
      INTEGER MONTH(12)                             !!!! wangyihe
      INTEGER KC(11,6)                              !!!! wangyihe
      REAL ADEPTH
      REAL HA(11),GA(11),PHASE(11),FREQ(11)         !!!! wangyihe
      REAL A(11),B(11),FF(11),UU(11)                !!!! wangyihe
      REAL times,S,HH,P,XN,PP,TAO,C,D,EL            !!!! wangyihe
      INTEGER kday,NADDI,KY,KKM                     !!!! wangyihe
      
c	DIMENSION MONTH(12),PHASE(11),FREQ(11)        !!!!! "c" by wangyihe
c	DIMENSION A(11),B(11),FF(11),UU(11)           !!!!! "c" by wangyihe
c	INTEGER KC(11,6)                              !!!!! "c" by wangyihe
c	DIMENSION HA(11),GA(11)                       !!!!! "c" by wangyihe
C
